...
public class BuscaEmProfundidade {
    ...
    public ArrayList<Vertice> buscaTodos(Grafo g, Vertice i, ArrayList<Vertice> caminho)
    {
        ...
        for(Aresta aresta : arestas)
        {
            ...
            {
                buscaTodos(g, v1, caminho);
            }
            else
            {
                if(!foiVisitado(v2, caminho))
                {
                    buscaTodos(g, v2, caminho);
                }
            }
        }        
        return caminho;        
    ...
    public ArrayList<Vertice> buscaAte(Grafo g, Vertice i, Vertice f, ArrayList<Vertice> caminho)
    {
        int posicao = g.getVertices().indexOf(i);
        caminho.add(i);
        ArrayList<Aresta> arestas = i.getArestas();
