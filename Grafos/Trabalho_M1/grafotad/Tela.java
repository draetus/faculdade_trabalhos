...
public class Tela extends javax.swing.JFrame {
     ...
     */
    public Tela(Grafo gArg, ArrayList<Integer> x, ArrayList<Integer> y) {
    ...
    public void paint(Graphics gra) {  
        ...
        for(Vertice v: g.getVertices())
        {
            for(Aresta a : v.getArestas())
            {
                ...
                int x1 = coordenadasX.get(g.getVertices().indexOf(v1)) +25;
                int x2 = coordenadasX.get(g.getVertices().indexOf(v2)) +25;
                int y1 = coordenadasY.get(g.getVertices().indexOf(v1)) +25;
                int y2 = coordenadasY.get(g.getVertices().indexOf(v2)) +25;
