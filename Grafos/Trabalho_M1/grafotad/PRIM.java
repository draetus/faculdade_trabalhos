...
public class PRIM {
    ...
    public static void run(Grafo g)
    {
    ...
    public static int[] pegaMenor(Grafo g, float[][] pesos, int[][] linhas)
    {
    ...
    public static int[] pegaPrimeiro(Grafo g, float[][] pesos)
    {
        int[] indices = new int[2];
        for (int i=0; i<g.getVertices().size(); i++)
        {
    ...
    public static boolean checaConcluido(Grafo g, int[][] linhas)
    {
        for (int i=0; i<g.getVertices().size(); i++)
        {
            for (int j=0; j<i; j++)
