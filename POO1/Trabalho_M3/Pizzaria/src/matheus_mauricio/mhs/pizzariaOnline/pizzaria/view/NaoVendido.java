...
/**
 *  Criador do relatorio de pizzas nao vendidas
 * 
 * @author Matheus Henrique Schaly e Mauricio Macario de Farias Junior
 */
public class NaoVendido extends Relatorio {

    /**
     * Construtor - Organiza Lista de itens pedidos de pedidos não confirmados
     ...
     */
    public NaoVendido(String cabecalho, String rodape, String titulo, Repositorio<Pedido> pedidos) {
