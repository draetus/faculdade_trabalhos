...
public class Employee extends Person {
    ...
    public int getYearsOfService() {
        ...
        if (this.isEmployee())
        {
            period = Period.between(hireDate, LocalDate.now());
        }
        else
        {
            period = Period.between(hireDate, terminationDate);
        }
    ...
    public BigDecimal getRegularWeekSalary() {
        ...
        value = value.multiply(hourlyRate);
    ...
    public BigDecimal getWeekPayment(int absentHours) {
        ...
        if (hourlyRate != null)
        {
            ...
            discount = discount.multiply(hourlyRate);
        }
        else
        {
